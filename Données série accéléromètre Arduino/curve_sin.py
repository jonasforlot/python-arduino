...
lines = open('p:\Mes documents\essais Python\Améliorations\Accéléromètre\Données série accéléromètre Arduino\data_accelerometre.txt').readlines() #on lit les lignes du fichier texte
open('p:\Mes documents\essais Python\Améliorations\Accéléromètre\Données série accéléromètre Arduino\data_new.txt', 'w').writelines(lines[1:]) #création d'un nouveau fichier texte sans la première ligne
data = np.loadtxt('p:\Mes documents\essais Python\Améliorations\Accéléromètre\Données série accéléromètre Arduino\data_new.txt')# importation du nouveau fichier texte pour récupérer les valeurs det, x et y dans un tableau
